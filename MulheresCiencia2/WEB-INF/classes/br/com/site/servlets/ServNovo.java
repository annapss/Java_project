...
public class ServNovo extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for (Part part : request.getParts()) { //Maneira pouco otimizada de isolar a Part da imagem
        	if (i == 3) {
	            fileName = Paths.get(part.getSubmittedFileName()).getFileName().toString(); //Conversão grande para assegurar que pega apenas o nome do arquivo independente do tipo de browser
